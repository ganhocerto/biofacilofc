...
export const INITIAL_NICHES: (Omit<Niche, 'createdAt' | 'updatedAt'> & { slug: string })[] = [
  {
    ...
    name: 'Barbearia',
    slug: 'barbearia',
    description: 'Cortes clássicos e modernos, navalha, agendamento WhatsApp e tabela de serviços',
    icon: 'Scissors',
    order: 1,
    active: true,
    modelCount: 1,
  },
  {
    ...
    name: 'Salão & Beleza',
    slug: 'salao-beleza',
    description: 'Cabelos, coloração, mechas, penteados e cuidados capilares avançados',
    icon: 'Sparkles',
    order: 2,
    active: true,
    modelCount: 0,
  },
  {
    ...
    name: 'Estética',
    slug: 'estetica',
    description: 'Harmonização facial, tratamentos corporais, botox, laser e skin care',
    icon: 'HeartPulse',
    order: 3,
    active: true,
    modelCount: 0,
  },
  {
    ...
    description: 'Cardápios digitais, bistrôs, food parks e reservas de mesa via WhatsApp',
    icon: 'Utensils',
    order: 4,
    active: true,
    modelCount: 0,
  },
  {
    ...
    description: 'Consultoria fitness, treinos individualizados e acompanhamento de resultados',
    icon: 'Dumbbell',
    order: 5,
    active: true,
    modelCount: 0,
  },
  {
    ...
    description: 'Imóveis de alto padrão, lançamentos, catálogo de propriedades e contato direto',
    icon: 'Building',
    order: 6,
    active: true,
    modelCount: 0,
  },
  {
    ...
    name: 'Advocacia',
    slug: 'advocacia',
    description: 'Escritórios jurídicos, consultoria preventiva, áreas de atuação e agendamento',
    icon: 'Scale',
    order: 7,
    active: true,
    modelCount: 0,
  ...
  {
    id: 'mecanica-automotivo',
    name: 'Mecânica & Automotivo',
    slug: 'mecanica-automotivo',
    description: 'Oficinas especializadas, estética automotiva, guincho e orçamentos rápidos',
    icon: 'Wrench',
    order: 8,
    active: true,
    modelCount: 0,
  ...
  {
    id: 'artista-cantor-dj',
    name: 'Artista / Cantor / DJ',
    slug: 'artista-cantor-dj',
    description: 'Presskit oficial, agenda de shows, lançamentos musicais, Spotify e redes',
    icon: 'Mic',
    order: 9,
    active: true,
    modelCount: 0,
  },
  {
    ...
    name: 'Loja & Comércio',
    slug: 'loja-comercio',
    description: 'Catálogo de produtos, novidades, ofertas especiais e pedidos direto pelo WhatsApp',
    icon: 'ShoppingBag',
    order: 10,
    active: true,
    modelCount: 0,
...
export const INITIAL_TEMPLATES: BiositeTemplate[] = [
  ...
  },
  {
    ...
    nicheId: 'restaurante-gastronomia',
    nicheName: 'Restaurante & Gastronomia',
